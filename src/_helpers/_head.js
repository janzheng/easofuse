...
const site_url = 'https://easeofuse.org';
const site_name = 'Ease of Use';
const site_title = 'Ease of Use';
const site_twitter = '@phagedirectory';
const site_twitter_creator = '@yawnxyz';
const site_color = '#014898';
const site_description = 'Ease of Use — a blog about usability, accessibility, and digital products';

// const site_ico = '/ico_dull.png'; // site icon
const site_ico = '/icon.png';
const site_image = '/share_img_pd.png';
...
export default {
  ...
  link: [
    ...
    { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Signika:wght@300;400;700&display=swap' },
